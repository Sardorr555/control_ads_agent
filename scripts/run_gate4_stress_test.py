...
def main():
    ...
    parser.add_argument("--payment-url", default="http://127.0.0.1:9222/api/v1/system/payment/init", help="Full URL to system_api.py payment init route via Nginx ingress (default: 127.0.0.1:9222)")
    ...
    try:
        ...
        print("=" * 80)
        print(f"  1. Payment Core Baseline p95 (Port 9222/Nginx):   {p95_base:.2f} ms")
        print(f"  2. Payment Core Under-Load p95 (Port 9222/Nginx):  {p95_stress:.2f} ms")
