...
class AutoModuleFinder:
    ...
    def find_spec(cls, fullname, path, target=None):
        for prefix in ['ruamel', 'filelock', 'infinity', 'pyobvector', 'opensearchpy', 'azure', 'qdrant_client', 'pymilvus', 'tidb_vector', 'minio', 'boto3', 'botocore', 'opendal', 'valkey', 'quart_schema', 'quart_cors', 'quart_auth', 'langfuse']:
